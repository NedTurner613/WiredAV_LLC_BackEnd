...
class ClientServiceTest {
    ...
    void createClient_ShouldMapAndSaveClient() {
        ...
        AddClientResponseDTO result = clientService.createClient(request);
        assertThat(result).isNotNull();
        assertThat(result.clientId()).isEqualTo(savedClient.getClientId());
        assertThat(result.firstName()).isEqualTo(savedClient.getFirstName());
        assertThat(result.lastName()).isEqualTo(savedClient.getLastName());
        assertThat(result.email()).isEqualTo(savedClient.getEmailAddress());
        assertThat(result.phoneNumber()).isEqualTo(savedClient.getPhoneNumber());
...
//        List<Clients> result = clientService.getClients(Pageable.ofSize(10));
//
...
//    }
    ...
    void getClientById_WhenExists_ShouldReturnClient() {
        ...
        GetClientResponseDTO result = clientService.getClientById(clientId);

        assertThat(result).isNotNull();
        assertThat(result.clientId()).isEqualTo(clientId);
        assertThat(result.firstName()).isEqualTo(client.getFirstName());
        assertThat(result.lastName()).isEqualTo(client.getLastName());
        assertThat(result.email()).isEqualTo(client.getEmailAddress());
        assertThat(result.phoneNumber()).isEqualTo(client.getPhoneNumber());
